    ...
    <div style={{ position: "relative", zIndex: 5, minHeight: "100vh" }}>
      ...
      <div style={{ padding: "6px 18px 44px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
          <div style={{ flex: 1, height: 9, borderRadius: 99, background: "rgba(63,92,82,.15)", overflow: "hidden" }}>
          ...
          {db.drinks.map((d) => (
            <Link key={d.id} href={`/drink/${d.id}`} style={{ textAlign: "center", color: "inherit" }}>
              <div style={{ width: "100%", background: "rgba(255,255,255,.35)", borderRadius: 11, padding: 6 }}>
                <div style={{ border: "1.2px solid rgba(32,48,42,.14)", borderRadius: 8, padding: "8px 5px 9px" }}>
                  <div
                    style={{
                      width: "100%",
                      aspectRatio: "3/4",
                      borderRadius: 5,
                      background: "rgba(63,92,82,.08)",
                      display: "flex",
                      alignItems: "center",
                  ...
                  >
                    <span style={{ fontSize: 22, color: "rgba(32,48,42,.28)" }}>?</span>
                  </div>
                  <div
                    className="serif"
                    style={{
                  ...
                  <div style={{ fontSize: 9, color: "rgba(32,48,42,.35)", marginTop: 2 }}>미획득</div>
                </div>
              </div>
            </Link>
          ))}
        ...
        <p style={{ margin: "22px 2px 0", fontSize: 12, lineHeight: 1.6, color: "rgba(32,48,42,.55)" }}>
