    ...
    <div style={{ position: "relative", zIndex: 5, minHeight: "100dvh" }}>
      ...
      <div style={{ padding: "24px 22px 44px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
          <div style={{ flex: 1, height: 9, borderRadius: 99, background: "rgba(120,95,50,.15)", overflow: "hidden" }}>
          ...
          {db.drinks.map((d) => (
            <Link key={d.id} href={`/drink/${d.id}`} style={{ textAlign: "center", color: "inherit" }}>
              <div style={{ width: "100%", background: "rgba(255,255,255,.35)", borderRadius: 11, padding: 6 }}>
                <div style={{ border: "1.2px solid rgba(120,95,50,.14)", borderRadius: 8, padding: "8px 5px 9px" }}>
                  <div
                    style={{
                      width: "100%",
                      aspectRatio: "3/4",
                      borderRadius: 5,
                      background: "rgba(120,95,50,.08)",
                      display: "flex",
                      alignItems: "center",
                  ...
                  >
                    <span style={{ fontSize: 22, color: "rgba(120,95,50,.28)" }}>?</span>
                  </div>
                  <div
                    className="serif"
                    style={{
                  ...
                  <div style={{ fontSize: 9, color: "rgba(120,95,50,.35)", marginTop: 2 }}>미획득</div>
                </div>
              </div>
            </Link>
          ))}
