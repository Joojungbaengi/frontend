...
.ar-ui .hand-debug,.ar-ui .depth-debug,.ar-ui .segment-debug,.ar-ui .hand-occlusion-debug,.ar-ui .fan-debug{position:absolute; top:calc(10px + env(safe-area-inset-top,0px));
...
.ar-ui .fan-debug{left:50%; transform:translateX(-50%)}
.ar-ui .hand-debug strong,.ar-ui .depth-debug strong,.ar-ui .segment-debug strong,.ar-ui .hand-occlusion-debug strong,.ar-ui .fan-debug strong{font-size:12px; letter-spacing:.08em; color:#ffe08a}
.ar-ui .hand-debug span,.ar-ui .depth-debug span,.ar-ui .segment-debug span,.ar-ui .hand-occlusion-debug span,.ar-ui .fan-debug span{display:block}
.ar-ui .hand-debug b,.ar-ui .depth-debug b,.ar-ui .segment-debug b,.ar-ui .hand-occlusion-debug b,.ar-ui .fan-debug b{font-weight:700}
.ar-ui .fan-debug .fan-flash{min-height:16px; margin-top:2px; text-align:center; color:#6effa8; font-size:16px; letter-spacing:.14em}
